...
gdxdump   %filepath%..\GDX\compare_timesreport.gdx format=csv symb=timesreport     output=%filepath%..\compare_timesreport.csv noHeader header=filename,timesmodel,scen,sow,sector,subsector,service,techgroup,comgroup,topic,attr,prc,com,timeslice,regionFrom,regionTo,year,vntg,units,cur,value
