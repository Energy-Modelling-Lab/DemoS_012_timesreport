...
*                                         |                                                                 |       \             |                |         /
* PARAMETER       TIMESReport(timesmodel,scen,sow,sector,subsector,service,techgroup,comgroup,sector,topic,attr,prc,com,all_TS,regfrom,regto,year,vntg,unit,cur) "Advanced TIMES reporting parameter";
*                                              |                                                                 |         |             |               
*                                        state-of-world                                                       proces    timeslice     region to        
*                                 
*
* The data format has been made ready to support stockastic modelling using the TIMES modelling framework by including the state-of-world dimension.
